...
if __name__ == "__main__":
    ...
    # 5_Kr(train+dev)_Kr(train)_Ko(train)_Kc(train+dev)
    ...
    model4 = torch.load("KcELECTRA_train&dev.pt")
    # test checkpoint
    ...
    output.to_csv("5_Kr(train+dev)_Kr(train)_Ko(train)_Kc(train+dev)_ensemble.csv", index=False)
