...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_epochs", default=48, type=int)
    ...
    wandb.init(name="KrELECTRA_ep48_bs16_train&dev", project='test jh', entity='nlp-11')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, "KrELECTRA_ep48_bs16_train&dev.pt")
