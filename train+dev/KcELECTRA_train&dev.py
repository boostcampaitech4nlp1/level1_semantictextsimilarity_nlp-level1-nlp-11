...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name", default="beomi/KcELECTRA-base", type=str
    )
    parser.add_argument("--batch_size", default=16, type=int)
    parser.add_argument("--max_epochs", default=44, type=int)
    ...
    wandb.init(name="KcELECTRA_train&dev", project='test-project', entity='nlp-11')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, "KcELECTRA_train&dev.pt")
