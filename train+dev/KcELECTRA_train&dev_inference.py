...
if __name__ == "__main__":
    ...
    # )
    # model = Model.load_from_checkpoint(
    #     "./dongchan-sweep-ep50/3ob3ymfv/checkpoints/epoch36-val_pearson0.9248.ckpt"
    # )
    model = torch.load("KcELECTRA_train&dev.pt")
    ...
    output.to_csv("KcELECTRA_train&dev.csv", index=False)
